...
import com.devseok.domain.usecase.other.GetEssayUseCase
import com.devseok.domain.usecase.other.GetRecommendationUseCase
...
class OtherViewModel @Inject constructor(
    ...
    fun getRecommendation() {
        _loading.value = true
        getRecommendationUseCase.execute().addOnSuccessListener { snapshot ->
    ...
    fun getEssay() = getEssayUseCase.execute().addOnSuccessListener { snapshot ->
