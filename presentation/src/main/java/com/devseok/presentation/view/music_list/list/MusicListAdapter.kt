...
import com.devseok.presentation.databinding.ItemMusicBriefBinding
import com.devseok.presentation.databinding.ItemMusicListBinding
...
import com.devseok.presentation.utils.TYPE_ALL
import com.devseok.presentation.utils.TYPE_BRIEF
...
class MusicListAdapter(private val listener: MusicListAdapterListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (listViewType == TYPE_ALL) {
            ...
            val binding = ItemMusicBriefBinding.inflate(LayoutInflater.from(parent.context), parent, false)
