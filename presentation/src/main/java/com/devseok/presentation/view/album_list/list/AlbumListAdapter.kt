...
import com.devseok.presentation.databinding.ItemAlbumBriefBinding
import com.devseok.presentation.databinding.ItemAlbumListBinding
...
class AlbumListAdapter(private val listener: AlbumListAdapterListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (listViewType == TYPE_ALL) {
            ...
            val binding = ItemAlbumBriefBinding.inflate(LayoutInflater.from(parent.context), parent, false)
